...
<!--#include file="menusx.inc" -->
          ...
          <div class="bf-main-content">
            ...
            <div class="bf-products-grid">
									...
									" ( marchio='" & Trim(Replace(Request("marchio1"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio2"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio3"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio4"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio5"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio6"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio7"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio8"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio10"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio11"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio12"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio13"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio14"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio15"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio16"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio17"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio18"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio19"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio20"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio21"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio22"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio23"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio24"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio25"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio26"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio27"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio28"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio29"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio30"),"%20"," ")) & "'" &_		
									" or marchio='" & Trim(Replace(Request("marchio1"),"%20"," ")) & "'" & aggiuntamarchio &_										
									" ) and fornitore like '%od%' and (p1>" & Trim(Replace(Request("minprezzo"),"%20"," ")) & " and p1<" & Trim(Replace(Request("maxprezzo"),"%20"," ")) & ")"
