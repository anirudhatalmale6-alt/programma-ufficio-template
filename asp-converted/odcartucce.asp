...
<tr>
	<td valign="top">
		<select name="marca" style="height:46px;" onchange="cartucce_lista(this[this.selectedIndex].value)" ID="marca" class="bf-form-select">
		<option value="----------">----------</option>
		<%
		tbmarche.moveFirst
		do while not tbmarche.eof
	...
	<td>&nbsp;&nbsp;</td>
	<td valign="top">
		<select name="modelloid" ID="modelloid" style="height:46px;" class="bf-form-select">
		<option value="----------">--------------------------</option>
		</select>
	</td>
	<td>&nbsp;&nbsp;</td>
	<td valign="top"><input type="submit" class="bf-btn bf-btn-red" style="height:46px;width:150px;" value="Search"></td>
</tr>
</form>
</table><br><br>
