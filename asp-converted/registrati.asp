...
Modifica=False
   ...
   if  trim(request("modifica"))="modifica" then
		...
		if Trim(Request("Id"))<>"" then
			...
			text_sdi=Tbutu("Sdi")
			text_tiporegistrazione=Tbutu("TipoRegistrazione")
		...
		Else
			...
			text_tiporegistrazione=senza_apice(Request.Form("tipoutente"))
			...
			if errore="false" and trim(request("tasto"))="invia" and text_utente<>"" and  text_password<>"" and  text_email<>"" then
				...
				if b then
					...
					HTML = HTML & "<img src='" & sitourllogo &"' height='105px;'><br>"
					HTML = HTML & "<hr style='border-top: 0.2px solid #000000;'>"
					HTML = HTML & "<b>Nome      : " & text_nome       & "<br>"
					HTML = HTML & "Cognome   : " & text_cognome    & "<br></b>"
					HTML = HTML & "<hr style='border-top: 0.2px solid #000000;'>"
					...
					HTML = HTML & "<hr style='border-top: 0.2px solid #000000;'>"
					HTML = HTML & "<b>Tipo di iscrizione  : " & text_tiporegistrazione   & "</b><br>"
					HTML = HTML & "<hr style='border-top: 0.2px solid #000000;'>"
					...
					HTML = HTML & "<br><a style='font-size=10;color:#00A5E9;' href='" & sitourl & "/confermamail.asp?mail=" & trim(text_email) & "'><b> PER ACCEDERE AL SITO DEVI CONFERMARE LA TUA MAIL (CLICCA QUI) </b></a><br><br><br>"
					HTML = HTML & "SE VI SONO ERRORI .... <a style='font-size=10;color:#000000;' href='" & sitourl & "contattaci.asp'>CONTATTACI TRAMITE FORM...</a> <br>"
					HTML = HTML & "</body>"
					HTML = HTML & "</html>"
					titolobreve=" - "
					Rt=SendEmail(spedizionemail,text_email,"ISCRIZIONE " & titolobreve,HTML)
					Rt1=SendEmail("info@webhousesas.net",text_email,"ISCRIZIONE " & titolobreve,HTML)
					Rt2=SendEmail("info@webhousesas.net","info@webhousesas.net","ISCRIZIONE " & titolobreve,HTML)
					Rt3=SendEmail(spedizionemail,spedizionemail,"ISCRIZIONE " & titolobreve,HTML)
  ...
  <div class="bf-container">
    ...
    <div class="bf-form-card">
      ...
      <form action="registrati.asp?tasto=invia#topage" method="post" id=formuu name=formuu>
        <table border="0" cellpadding="0" cellspacing="0" width="98%" class="bf-form-table">
          <tr>
            ...
            if errore="false" then%>
              <%If Modifica=false then %>
              	<!---font color="#00A5E9"><br><strong>REGISTRAZIONE AVVENUTA CON SUCCESSO! ECCO I TUOI DATI!<br>
              	LO STAFF RINGRAZIA PER LA SCELTA<br></strong></font--->
              <%End If%>
            <%else%>
              <% if request("tasto")<>"" then%>
              <font color="#00A5E9"><b><center class=nero10>Errori >>>><% Response.write(ucase(verrore)) %>    </center></b></font>
              <%end if%>
            <%end if%>
          ...
          <tr><td colspan="2" height="1px" bgcolor="#00A5E9"></td></tr>
          <tr><td colspan="2" height="10px"></td></tr>
          ...
          %>
          <tr <%=bg%>>
            <td align=left width="160px">&nbsp;Cognome / Referente:<font color="#00A5E9">*</font></td>
            <td align=left><input type="text" class="bf-form-input" style="width:450px;" size="35" id="cognome" maxlength="125" name="cognome" value="<%=text_Cognome%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          bg=""
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Nome:<font color="#00A5E9">*</font></td>
            <td align=left><input type="text" class="bf-form-input" style="width:450px;" size="35" id="nome" maxlength="125" name="nome" value="<%=text_Nome%>"></td>
          </tr>
          <tr><td colspan="2" height="10px"></td></tr>
          <tr><td colspan="2" height="1px" bgcolor="#00A5E9"></td></tr>
          <tr><td colspan="2" height="10px"></td></tr>
          ...
          %>
          <tr <%=bg%>>
            <td width="160px" align="left">&nbsp;Nome Azienda <br>(ragione sociale):<font color="#00A5E9">*</font></td>
            <td align="left" valign="bottom"><input class="bf-form-input" style="width:450px;" id="Azienda" size=45 maxlength="125" type="text" name="Azienda" value="<%=text_Azienda%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          bg=""
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Partita Iva:<font color="#00A5E9">*</font></td>
            <td align=left><input size="35" class="bf-form-input" style="width:450px;" type="text" id="Partitaiva" maxlength="125" name="Partitaiva" value="<%=text_Partitaiva%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          </table>
          </div>
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Cod.Fiscale:<font color="#00A5E9">*</font></td>
            <td align=left><input size="35" class="bf-form-input" style="width:450px;" type="text" id="Codicefiscale" maxlength="125" name="Codicefiscale" value="<%=text_codicefiscale%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Cod.SDI(fatt.elettronica):<font color="#00A5E9">*</font></td>
            <td align=left><input class="bf-form-input" style="width:150px;" size="35" type="text" id="sdi" name="sdi" value="<%=text_sdi%>">
            </td>
          </tr>
          <tr><td colspan="2" height="10px"></td></tr>
          <tr><td colspan="2" height="1px" bgcolor="#00A5E9"></td></tr>
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Indirizzo:<font color="#00A5E9">*</font></td>
            <td align=left><input type="text" class="bf-form-input" style="width:450px;" id="text_3" maxlength="130" name="indirizzo" size=45 value="<%=text_Indirizzo%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          bg=""
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Citta'/Comune:<font color="#00A5E9">*</font></td>
            <td align=left><input type="text" class="bf-form-input" style="width:450px;" size="35" id="citta" name="citta" maxlength="145" value="<%=text_Citta%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          bg=""
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Cap:<font color="#00A5E9">*</font></td>
            <td align=left><input type="text" class="bf-form-input" style="width:150px;" size="8" id="cap" name="cap" maxlength="15" value="<%=text_Cap%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          bg=""
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Nazione:<font color="#00A5E9">*</font></td>
            <td align=left>
              <select id="nazione" class="bf-form-select" style="width:450px;text-transform: uppercase;" name="nazione">
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Provincia:<font color="#00A5E9">*</font></td>
            <td align=left>
            <select class="bf-form-select" style="width:450px;text-transform: uppercase;" id="Provincia" name="Provincia">
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;E-Mail:<font color="#00A5E9">*</font></td>
            <td align=left><input class="bf-form-input" type="text" id="text_6" name="email" size=45 value="<%=text_Email%>"></td>
          </tr>
          <tr><td height="5px"></td></tr>
          <%
          bg=""
          ...
          %>
          <tr <%=bg%>>
            <td align=left>&nbsp;Telefono/ Cellulare/ Fax:<font color="#00A5E9">*</font></td>
            <td align=left><input class="bf-form-input" type="text" id="telefono" maxlength="130" name="telefono" size=45 value="<%=text_telefono%>"></td>
          </tr>
          ...
          <tr>
            ...
            <table cellspacing="0" cellpadding="0" width="350" class="tx1 grigio_scuro" border="0">
                ...
                <%
                  ...
                  %>
                  <tr <%=bg%>>
                  <td align=left>&nbsp;Utente<font color="#00A5E9">*</font></td>
                  <td align=left>&nbsp; <input class="bf-form-input" type="text" size="35" id="Utente" maxlength="125" name="Utente" value="<%=text_utente%>"></td>
                </tr>
                <tr><td height="5px"></td></tr>
                <%
                  bg=""
                  ...
                  %>
                  <tr <%=bg%>>
                  <td align=left>&nbsp;Password<font color="#00A5E9">*</font></td>
                  <td align=left>&nbsp; <input class="bf-form-input" type="password" size="35" id="Password" maxlength="125" name="Password" value="<%=text_Password%>"></td>
                </tr>
                <tr>
                ...
                <%
                  ...
                  %>
                  <tr <%=bg%>>
                  <td colspan=2 align=left>&nbsp;Ricopialo qui <input class="bf-form-input" type="text" size="8" id="checktext" maxlength="4" name="checktext" style="width:150px;display:inline-block;"></td>
                </tr>
            </table></td>
          </tr>
          ...
          <tr>
            <td align="left">
              ...
              <br>
              <a class="yBox yBox_iframe" href="privacy.asp"><img src='images/gdpr-logo.png'   border="0">&nbsp;&nbsp;&nbsp;</a>
              <br>
              In esecuzione come da GDPR - REGOLAMENTO 2016 / 679, recante disposizioni a tutela delle persone e degli altri soggetti rispetto
              al trattamento dei dati personali, dichiaro di aver letto  apposita <A class="yBox yBox_iframe" href="privacy.asp" class="tx1 azzurro lnk">informativa</A> e fornisco il consenso al trattamento dei miei
              dati personali.<br>
          ...
          <tr><td colspan="2" align="left">&nbsp;<button type="submit" class="bf-btn-submit" value="Registrati ora.">Registrati ora.</button></td></tr>
        </table>
            <%
